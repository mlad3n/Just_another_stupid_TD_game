...
public class Gras1_Tile1_up extends Field {


	private SurfaceView _surface;
	
	public Gras1_Tile1_up(SurfaceView view){
		super();
		_surface = view;
	...
	protected void initializeSprites(SurfaceView view) {
		...
		_sprites[0] = BitmapFactory.decodeResource(view.getResources(), R.drawable.trava1_plocice1_copy, options);
	}
